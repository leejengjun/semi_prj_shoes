...
public class Notice_write2Action extends AbstractController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if( loginuser != null && "admin".equals(loginuser.getUserid()) ) {
			...
			if(!"post".equalsIgnoreCase(method)) {	
				...
				super.setViewPage("/WEB-INF/n01_JeongKyeongEun/notice_write.jsp");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//		    System.out.println("=== 첨부되어지는 이미지 파일이 올라가는 절대경로 uploadFileDir ==> " + uploadFileDir);
	          ...
	          */
				...
				try {  // 잘못됐을때는 이렇게 끝난다.
	                ...
	                request.setAttribute("loc", request.getContextPath()+"/notice_write2.shoes");  // 안 되면 여기 확인
			...
			// ===== 파일을 업로드 해준다. 끝 ===== //
				...
				// === 첨부 이미지 파일을 올렸으니 그 다음으로 글정보 (아이디, 제목, 글내용,...) DB의 tbl_board_notice 테이블에 insert 를 해주어야 한다.  ===
				...
				if (n==1) {	// DAO 에서 1 값이 return 됐을 경우 .
					...
					loc = request.getContextPath()+"/notice.shoes";	// 글목록으로 이동
				}
				else {
	...
	////////////////////////////////////////////////////////////////////////////////////////////////	
		...
		else {	// 로그인을 하지 않았거나 일반사용자가 글쓰기 주소로 들어간 경우
			
			String message = "관리자만 공지사항 작성이 가능합니다.";
