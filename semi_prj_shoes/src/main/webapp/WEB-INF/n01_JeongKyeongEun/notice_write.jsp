...
<script type="text/javascript">
  ...
  $(document).ready(function(){
	  ...
	  $("button#btnSubmit").click(function(){
		...
		const frm = document.notice_Frm;
		frm.action = "<%= ctxPath%>/notice_write2.shoes";
		frm.method = "post";
		frm.submit();
...
<body>
	...
	<div class="container" role="main">
		<form name="notice_Frm" enctype="multipart/form-data">
		            ...
		            <td bgcolor=white>
			            <table class = "table2">
							...
							<!-- 작성자 받아오기!!! hidden 으로 감춰놈 -->
							 <tr>
				                 <input type="hidden" style="width: 100%" name="n_userid" value="admin" />
				             </tr>
							
							<!-- 글제목 쓰기!!!  -->
							<tr>
				                <td>제목</td>
				                <td><input name="n_title" type="text" size="105" maxlength="100" required autofocus /></td>
				            </tr>
				            
							<!-- 글내용 쓰기!!!  -->
							<tr>
				                <td>글내용</td>
				                <td><textarea name="n_contents" maxlength="4000" cols="107" rows="17"></textarea></td>
				            </tr>
