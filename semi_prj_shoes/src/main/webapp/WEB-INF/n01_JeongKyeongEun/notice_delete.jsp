...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("button#deleteYes").click(function() {
			var frm = document.noticeDeleteFrm;
			frm.action = "<%= ctxPath%>/noticeDelete.shoes";
			frm.method = "post";
			frm.submit();		
		});
		...
		$("button#deleteNo").click(function() {
			self.close();
			opener.location.href="<%= ctxPath%>/notice_contents.shoes?notice_no="+notice_no+"&goBackURL=${requestScope.goBackURL}";
...
<%-- 글내용 보기에서 '삭제'버튼 클릭 시 해당 글번호 --%>
	<form name="noticeDeleteFrm">
		<input type="hidden" name="notice_no" value="${requestScope.notice_no}">
		<input type="hidden" name="n_userid" value="${requestScope.n_userid}">
	</form>
